...
match_agent = Agent(
    ...
    model=Gemini(id="gemini-2.0-flash"),  # Using OpenAI GPT-4o
    tools=[DuckDuckGo()],
    instructions=[
...
cricket_team.print_response(
    "Cretae a summarize table to Get the latest score of the India vs south africa match, recent stats for Ruthu raj gaikward, and cricket news.", 
    stream=True
)